...
import { Mail, Lock, User as UserIcon, ArrowRight, Eye, EyeOff, Loader2, Flower2 } from 'lucide-react';
        ...
        <div className="hidden md:flex flex-col justify-center p-12 bg-primary relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-4xl font-serif italic text-white mb-6 leading-tight">
              {isLogin ? "Chào mừng bạn quay trở lại với FLORA" : "Khởi đầu hành trình yêu thương cùng FLORA"}
            </h1>
        ...
        <div className="p-8 md:p-12 flex flex-col justify-center">
          <div className="mb-8">
            ...
            <p className="text-ink/40 text-xs uppercase tracking-[0.2em]">
              {isLogin ? "Vui lòng nhập thông tin của bạn" : "Tạo tài khoản mới hôm nay"}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {!isLogin && (
              <div className="space-y-1.5">
                <label className="text-[10px] font-bold uppercase tracking-widest text-ink/40 ml-4">Họ và tên</label>
            ...
            <div className="space-y-1.5">
              <label className="text-[10px] font-bold uppercase tracking-widest text-ink/40 ml-4">Email</label>
              <div className="relative group">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center px-4">
                <label className="text-[10px] font-bold uppercase tracking-widest text-ink/40">Mật khẩu</label>
                {isLogin && (
                  <button type="button" className="text-[10px] font-bold text-accent hover:underline">Quên mật khẩu?</button>
                )}
              </div>
              <div className="relative group">
